...
echo "→ http://localhost:$PORT/nodus/                      (Nodus – výuka)"
echo "→ http://localhost:$PORT/nodus/obsah/planet_globe.html (glóbusy planet)"
echo "→ http://localhost:$PORT/obsah/weather_globe.html      (glóbus počasí)"
echo "→ http://localhost:$PORT/nodus/obsah/solar_system.html (sluneční soustava)"
echo
