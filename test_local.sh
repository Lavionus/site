...
echo "→ http://localhost:$PORT/metodus/                      (Metodus – výuka)"
echo "→ http://localhost:$PORT/metodus/obsah/planet_globe.html (glóbusy planet)"
echo "→ http://localhost:$PORT/obsah/weather_globe.html      (glóbus počasí)"
echo "→ http://localhost:$PORT/metodus/obsah/solar_system.html (sluneční soustava)"
echo
